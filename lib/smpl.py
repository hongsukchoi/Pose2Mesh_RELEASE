...
class SMPL(object):
    def __init__(self):
        ...
        self.joint_regressor_h36m = np.load(osp.join(cfg.data_dir, 'Human36M', 'J_regressor_h36m_correct.npy')).astype(np.float32)
    ...
    def get_layer(self, gender):
        return SMPL_Layer(gender=gender, model_root=cfg.smpl_dir + '/smplpytorch/native/models')
